...
class PlainItemSchema(Schema):
    ...
    type = fields.Str(required=True, validate=OneOf(["COMMODITY", "SERVICE"]))
...
class FolderSchema(PlainFolderSchema):
...
class ItemEditSchema(Schema):
    ...
    new_type = fields.Str(validate=OneOf(["COMMODITY", "SERVICE"]))
    new_unit = fields.Str(validate=OneOf(["PIECE", "KILOGRAM", "LITER"]))
