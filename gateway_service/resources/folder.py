...
from schemas import MessageOnlySchema, FolderReturnSchema, FolderEditSchema, MessageWithIDSchema, PlainFolderSchema
...
class Folder(MethodView):
    ...
    def get(self, folder_id):
        result = send_request('GET', f"{ITEM_SERVICE_URL}/folder/{folder_id}",
    ...
    def put(self, folder_edit_data, folder_id):
        result_put = send_request('PUT', f"{ITEM_SERVICE_URL}/folder/{folder_id}", data=folder_edit_data,
                                  params=get_shop_id_params())
    ...
    def delete(self, folder_id):
        result_delete = send_request('DELETE', f"{ITEM_SERVICE_URL}/folder/{folder_id}",
                                     params=get_shop_id_params())
